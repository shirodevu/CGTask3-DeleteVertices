...
public class ObjReader {
	...
	protected static Vector3f parseVertex(final List<String> wordsInLineWithoutToken, int lineInd) {
		try {
			...
			throw new ObjReaderException("Failed to parse float value.");

		} catch(IndexOutOfBoundsException e) {
			throw new ObjReaderException("Too few vertex arguments.");
		}
	}
	...
	protected static Vector2f parseTextureVertex(final List<String> wordsInLineWithoutToken, int lineInd) {
		try {
			...
			throw new ObjReaderException("Too few texture vertex arguments.");
		}
	}
	...
	protected static Vector3f parseNormal(final List<String> wordsInLineWithoutToken, int lineInd) {
		try {
			...
			throw new ObjReaderException("Too few normal arguments.");
		}
	}

	protected static Polygon parseFace(final List<String> wordsInLineWithoutToken, int lineInd) {
		List<Integer> onePolygonVertexIndices = new ArrayList<Integer>();
		List<Integer> onePolygonTextureVertexIndices = new ArrayList<Integer>();
		List<Integer> onePolygonNormalIndices = new ArrayList<Integer>();
	...
	protected static void parseFaceWord(
		...
		try {
			...
			switch (wordIndices.length) {
				...
				default -> {
					throw new ObjReaderException("Invalid element size.");
				}
			}

		} catch(NumberFormatException e) {
			throw new ObjReaderException("Failed to parse int value.");

		} catch(IndexOutOfBoundsException e) {
			throw new ObjReaderException("Too few arguments.");
		}
	}
}
